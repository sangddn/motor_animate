...
void main() {
  ...
  testWidgets('ScaleEffect: scaleXY', (tester) async {
    final animation = const FlutterLogo().animate().scaleXY(
          motion: Motion.linear(1000.ms),
          end: 2,
        );
  ...
  testWidgets('ScaleEffect: scaleX', (tester) async {
    final animation = const FlutterLogo().animate().scaleX(
          motion: Motion.linear(1000.ms),
          end: 2,
        );
  ...
  testWidgets('ScaleEffect: scaleY', (tester) async {
    final animation = const FlutterLogo().animate().scaleY(
          motion: Motion.linear(1000.ms),
          end: 2,
        );
