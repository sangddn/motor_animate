...
void main() {
  testWidgets('SaturateEffect: saturate', (tester) async {
    final animation =
        const FlutterLogo().animate().saturate(motion: Motion.linear(1000.ms));
  ...
  testWidgets('SaturateEffect: desaturate', (tester) async {
    final animation = const FlutterLogo().animate().desaturate(
...
Future<void> _verifySaturate(WidgetTester tester, double amt) async {
