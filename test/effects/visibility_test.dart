...
void main() {
  testWidgets('VisibilityEffect: maintain = true', (tester) async {
    final animation = const FlutterLogo().animate().visibility(
  ...
  testWidgets('VisibilityEffect: hide', (tester) async {
    final animation =
        const FlutterLogo().animate().hide(motion: Motion.linear(1000.ms));
  ...
  testWidgets('VisibilityEffect: show', (tester) async {
    final animation =
        const FlutterLogo().animate().show(motion: Motion.linear(1000.ms));
...
Future<void> _verifyVisibility(
  WidgetTester tester,
  bool visible, [
  bool maintain = VisibilityEffect.defaultMaintain,
]) async {
  tester.expectWidgetWithBool<Visibility>((o) => o.visible, visible, 'visible');
  tester.expectWidgetWithBool<Visibility>(
    (o) => o.maintainAnimation,
    maintain,
    'maintainSize',
  );
  tester.expectWidgetWithBool<Visibility>(
    (o) => o.maintainInteractivity,
    maintain,
    'maintainInteractivity',
  );
  tester.expectWidgetWithBool<Visibility>(
    (o) => o.maintainSemantics,
    maintain,
    'maintainSemantics',
  );
  tester.expectWidgetWithBool<Visibility>(
