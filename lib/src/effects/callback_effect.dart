...
// Note: this whole thing is pretty messy / complex because AnimateController
...
///   .fadeIn(motion: Motion.linear(600.ms))
///   .callback(
///     motion: Motion.linear(300.ms),
...
extension CallbackEffectExtensions<T extends AnimateManager<T>> on T {
  ...
  T callback({
    ...
    required ValueChanged<bool> callback,
      ...
      addEffect(
        CallbackEffect(delay: delay, motion: motion, callback: callback),
      );
}
