...
class VisibilityEffect extends Effect<bool> {
  ...
  const VisibilityEffect({
    ...
    bool? maintain,
        ...
        super(begin: !(end ?? neutralValue), end: end ?? neutralValue);
...
extension VisibilityEffectExtensions<T extends AnimateManager<T>> on T {
  ...
  T show({Duration? delay, Motion? motion, bool? maintain}) => addEffect(
        VisibilityEffect(
          delay: delay,
          motion: motion,
          end: true,
  ...
  T hide({Duration? delay, Motion? motion, bool? maintain}) => addEffect(
        VisibilityEffect(
          delay: delay,
          motion: motion,
          end: false,
