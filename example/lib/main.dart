...
import 'examples/motor_imperative_view.dart';
...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return const MaterialApp(
      title: 'Motor Animate Demo',
      debugShowCheckedModeBanner: false,
      home: MotorAnimateExample(),
    );
  }
}

// this is a very quick and dirty example.
class MotorAnimateExample extends StatefulWidget {
  const MotorAnimateExample({super.key});

  static final List<TabInfo> tabs = [
    TabInfo(
      Icons.info_outline,
      (_) => InfoView(key: UniqueKey()),
      'Info',
      'Simple example of Widget & List animations.',
    ),
    TabInfo(
      Icons.palette_outlined,
      (_) => VisualView(key: UniqueKey()),
      'Visual',
    ...
    TabInfo(
      Icons.tune,
      (_) => const MotorImperativeView(),
      'Imperative',
      'Imperative API with motor-driven curves and springs.',
    ),
    TabInfo(
    ...
    TabInfo(
      ...
      (_) => PlaygroundView(key: UniqueKey()),
      'Playground',
  ...
  @override
  State<MotorAnimateExample> createState() => _MotorAnimateExampleState();
}

class _MotorAnimateExampleState extends State<MotorAnimateExample> {
  int _viewIndex = 0;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          for (final tab in MotorAnimateExample.tabs)
      ...
      body: DefaultTextStyle(
        ...
        child: SafeArea(
          bottom: false,
          child: MotorAnimateExample.tabs[_viewIndex].builder(context),
        ),
      ),
    );
  }
