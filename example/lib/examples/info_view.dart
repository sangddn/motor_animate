...
class InfoView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    title = title
        ...
        .shimmer(motion: Motion.linear(1200.ms), color: const Color(0xFF80DDFF))
        .animate() // this wraps the previous Animate in another Animate
        .fadeIn(motion: Motion.curved(1200.ms, Curves.easeOutQuad))
        .slide();
    ...
    tabInfoItems = tabInfoItems
        ...
        .fadeIn(motion: Motion.linear(900.ms), delay: 300.ms)
        .shimmer(blendMode: BlendMode.srcOver, color: Colors.white12)
        .move(
          begin: const Offset(-16, 0),
          motion: Motion.curved(300.ms, Curves.easeOutQuad),
        );
    ...
    return ListView(
      ...
      children: [
        ...
        const Text(
          '''
This simple app demonstrates a few features of the motor_animate library. More examples coming as time permits.
...
Switch between examples via the bottom nav bar. Tap again to restart that animation.''',
  ...
  Widget get hr => Container(
        ...
        margin: const EdgeInsets.symmetric(vertical: 16),
          ...
          motion: Motion.linear(600.ms), alignment: Alignment.centerLeft);
}
