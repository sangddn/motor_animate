...
class EverythingView extends StatelessWidget {
        ...
        children: [
          ...
          ***/
          tile(
            ...
            a
                .fadeIn(motion: Motion.curved(300.ms, Curves.easeOutCirc))
          ...
          tile(
            'fade+blur+move',
            a
                .fadeIn(motion: Motion.curved(300.ms, Curves.easeOutExpo))
                .blurY(begin: 32)
          ...
          tile(
            ...
            a.scale(
              ...
              motion: Motion.curved(300.ms, Curves.elasticOut),
            ),
          ),
          tile(
          ...
          tile(
            ...
            a
                .shimmer(
                  ...
                  angle: pi / 4,
                  size: 3,
                  motion: Motion.curved(300.ms, Curves.easeInOutCirc),
                )
                .rotate(begin: -pi / 12),
          ),
          tile(
          ...
          tile(
            ...
            a
                .shake(
                    motion: Motion.curved(300.ms, Curves.easeInOutCubic), hz: 3)
                .scaleXY(begin: 0.8)
          ...
          tile(
            'shake+slide+slide',
            a
                .shake(motion: Motion.curved(300.ms, Curves.easeInOut), hz: 0.5)
                .slideX(
                    motion: Motion.curved(300.ms, Curves.easeOut),
                    begin: -0.4,
                    end: 0.4)
                .slideY(
                    motion: Motion.curved(300.ms, Curves.bounceOut),
                    begin: -0.4,
                    end: 0.4),
          ),
          tile(
            ...
            a
                .boxShadow(
                  ...
                  motion: Motion.curved(300.ms, Curves.easeOutExpo),
                )
                .scaleXY(
                  end: 1.1,
                  motion: Motion.curved(300.ms, Curves.easeOutCirc),
                ),
          ),
          tile(
            ...
            a
                ...
                .scaleXY(
                  begin: 0.75,
                  motion: Motion.curved(300.ms, Curves.easeInOutQuad),
                )
                .untint(begin: 0.6),
          ),
  ...
  Animate get a => box
      ...
      .effect(
          motion: Motion.linear(3000.ms)) // this "pads out" the total duration
      .effect(delay: 750.ms, motion: Motion.linear(1500.ms)); // set defaults
